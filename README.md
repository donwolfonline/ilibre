...
iLibre is an open-source link in bio tool for everyone.

The goal of iLibre is to provide users with a platform that helps them to connect to their audience through a single link.

Official site: [https://ilibre.vercel.app](https://ilibre.vercel.app)

An example iLibre page: [https://ilibre.vercel.app/](https://ilibre.vercel.app/maayez)
...
iLibre is created with the NextJS web framework and follows its project structure.
...
1. Download the repo `git clone https://github.com/donwolfonline/iLibre.git`
2. Change the directory `cd iLibre`
3. Install the dependency `npm install`
4. Start a development server `npm run dev`
5. Open your browser and visit [http://localhost:3000](http://localhost:3000) to see iLibre live

## Contributing 🤝

We love our contributors! Here's how you can contribute:

- [Open an issue](https://github.com/donwolfonline/iLibre/issues) if you believe you've encountered a bug.
- Make a [pull request](https://github.com/donwolfonline/iLibre/pull) to add new features/make quality-of-life improvements/fix bugs.

<a href="https://github.com/donwolfonline/iLibre/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=donwolfonline/iLibre" />
</a>
